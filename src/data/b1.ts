...
export const B1_VOCAB: readonly VocabItem[] = [
  ...
  /* s01 */
  v("b1_v_stellenanzeige", "noun", "Stellenanzeige", "die", ["job advertisement", "job ad"], ["die Stellenanzeigen", "Stellenanzeigen"],
    bi("die Anzeige → die Anzeigen.", "die Anzeige → die Anzeigen."), S.arbeit),
  v("b1_v_vorstellungsgespraech", "noun", "Vorstellungsgespräch", "das", ["job interview"], ["die Vorstellungsgespräche", "Vorstellungsgespräche"],
    bi("das Gespräch → die Gespräche.", "das Gespräch → die Gespräche."), S.arbeit),
  v("b1_v_berufserfahrung", "noun", "Berufserfahrung", "die", ["work experience", "professional experience"], ["die Berufserfahrungen", "Berufserfahrungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.arbeit),
  v("b1_v_qualifikation", "noun", "Qualifikation", "die", ["qualification"], ["die Qualifikationen", "Qualifikationen"],
    bi("-ion → feminin, Plural -en.", "-ion → feminine, plural -en."), S.arbeit),
  v("b1_v_arbeitsbedingung", "noun", "Arbeitsbedingung", "die", ["working condition"], ["die Arbeitsbedingungen", "Arbeitsbedingungen"],
    bi("-ung → feminin; meist im Plural: die Arbeitsbedingungen.", "-ung → feminine; mostly plural: die Arbeitsbedingungen."), S.arbeit),
  v("b1_v_betriebsrat", "noun", "Betriebsrat", "der", ["works council"], ["die Betriebsräte", "Betriebsräte"],
    bi("der Rat → die Räte: Umlaut + -e.", "der Rat → die Räte: umlaut plus -e."), S.arbeit),
  v("b1_v_weiterbildung", "noun", "Weiterbildung", "die", ["further training", "continuing education"], ["die Weiterbildungen", "Weiterbildungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.arbeit),

  /* s02 */
  v("b1_v_wohngemeinschaft", "noun", "Wohngemeinschaft", "die", ["flat-share", "shared flat"], ["die Wohngemeinschaften", "Wohngemeinschaften"],
    bi("-schaft → feminin. Kurz: die WG.", "-schaft → feminine. Short: die WG."), S.wohnen),
  v("b1_v_ruhezeit", "noun", "Ruhezeit", "die", ["quiet hours", "rest period"], ["die Ruhezeiten", "Ruhezeiten"],
    bi("die Zeit → die Zeiten.", "die Zeit → die Zeiten."), S.wohnen),
  v("b1_v_laerm", "noun", "Lärm", "der", ["noise"], [NO_PLURAL],
    bi("Maskulin, kein Plural. Lärm machen.", "Masculine, no plural. Lärm machen."), S.wohnen),
  v("b1_v_streit", "noun", "Streit", "der", ["argument", "quarrel", "dispute"], [NO_PLURAL],
    bi("Maskulin; im Alltag kein Plural. Streit haben mit.", "Masculine; no plural in everyday use. Streit haben mit."), S.wohnen),
  v("b1_v_streiten", "verb", "sich streiten", "haben", ["to argue", "to quarrel", "argue"], ["gestritten"],
    bi("Reflexiv + mit / über. ei → i: gestritten.", "Reflexive + mit / über. ei → i: gestritten."), S.wohnen),
  v("b1_v_hausverwaltung", "noun", "Hausverwaltung", "die", ["property management"], ["die Hausverwaltungen", "Hausverwaltungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.wohnen),
  v("b1_v_umgebung", "noun", "Umgebung", "die", ["surroundings", "neighbourhood", "area"], ["die Umgebungen", "Umgebungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.wohnen),
  v("b1_v_viertel", "noun", "Viertel", "das", ["neighbourhood", "quarter", "district"], ["die Viertel", "Viertel"],
    bi("Neutrum, Plural unverändert. Auch: ein Viertel = ¼.", "Neuter, plural unchanged. Also: ein Viertel = ¼."), S.wohnen),
  v("b1_v_kuendigungsfrist", "noun", "Kündigungsfrist", "die", ["notice period"], ["die Kündigungsfristen", "Kündigungsfristen"],
    bi("die Frist → die Fristen.", "die Frist → die Fristen."), S.wohnen),
  v("b1_v_erhoehen", "verb", "erhöhen", "haben", ["to raise", "to increase", "raise"], ["erhöht"],
    bi("er- → kein ge-: erhöht. Die Miete erhöhen.", "er- → no ge-: erhöht. Die Miete erhöhen."), S.wohnen),

  /* s03 */
  v("b1_v_operation", "noun", "Operation", "die", ["operation", "surgery"], ["die Operationen", "Operationen"],
    bi("-ion → feminin, Plural -en.", "-ion → feminine, plural -en."), S.gesund),
  v("b1_v_operieren", "verb", "operieren", "haben", ["to operate", "operate"], ["operiert"],
    bi("-ieren → kein ge-: operiert.", "-ieren → no ge-: operiert."), S.gesund),
  v("b1_v_diagnose", "noun", "Diagnose", "die", ["diagnosis"], ["die Diagnosen", "Diagnosen"],
    bi("-e → feminin, Plural -n.", "-e → feminine, plural -n."), S.gesund),
  v("b1_v_stress", "noun", "Stress", "der", ["stress"], [NO_PLURAL],
    bi("Maskulin, kein Plural. Stress haben.", "Masculine, no plural. Stress haben."), S.gesund),
  v("b1_v_vorsorge", "noun", "Vorsorge", "die", ["preventive care", "provision"], [NO_PLURAL],
    bi("Feminin, kein Plural. Die Vorsorgeuntersuchung.", "Feminine, no plural. Die Vorsorgeuntersuchung."), S.gesund),
  v("b1_v_kalorie", "noun", "Kalorie", "die", ["calorie"], ["die Kalorien", "Kalorien"],
    bi("-ie → feminin, Plural -n.", "-ie → feminine, plural -n."), S.gesund),
  v("b1_v_zucker", "noun", "Zucker", "der", ["sugar"], [NO_PLURAL],
    bi("Maskulin, kein Plural.", "Masculine, no plural."), S.gesund),
  v("b1_v_fett", "noun", "Fett", "das", ["fat"], ["die Fette", "Fette"],
    bi("Neutrum, Plural -e (Fettarten).", "Neuter, plural -e (kinds of fat)."), S.gesund),
  v("b1_v_sucht", "noun", "Sucht", "die", ["addiction"], ["die Süchte", "Süchte"],
    bi("Umlaut + -e: die Süchte. Adjektiv: süchtig.", "Umlaut plus -e: die Süchte. Adjective: süchtig."), S.gesund),
  v("b1_v_fitnessstudio", "noun", "Fitnessstudio", "das", ["gym"], ["die Fitnessstudios", "Fitnessstudios"],
    bi("Fremdwort, Plural -s. Drei s in der Mitte.", "Loanword, plural -s. Three s's in the middle."), S.gesund),

  /* s04 */
  v("b1_v_schulsystem", "noun", "Schulsystem", "das", ["school system"], ["die Schulsysteme", "Schulsysteme"],
    bi("das System → die Systeme.", "das System → die Systeme."), S.bildung),
  v("b1_v_grundschule", "noun", "Grundschule", "die", ["primary school"], ["die Grundschulen", "Grundschulen"],
    bi("die Schule → die Schulen.", "die Schule → die Schulen."), S.bildung),
  v("b1_v_gymnasium", "noun", "Gymnasium", "das", ["grammar school", "academic secondary school"], ["die Gymnasien", "Gymnasien"],
    bi("-ium → neutrum, Plural -ien. Kein Fitnessstudio!", "-ium → neuter, plural -ien. Not a gym!"), S.bildung),
  v("b1_v_realschule", "noun", "Realschule", "die", ["secondary school (intermediate)"], ["die Realschulen", "Realschulen"],
    bi("die Schule → die Schulen.", "die Schule → die Schulen."), S.bildung),
  v("b1_v_lehre", "noun", "Lehre", "die", ["apprenticeship"], ["die Lehren", "Lehren"],
    bi("-e → feminin, Plural -n. Eine Lehre machen.", "-e → feminine, plural -n. Eine Lehre machen."), S.bildung),
  v("b1_v_universitaet", "noun", "Universität", "die", ["university"], ["die Universitäten", "Universitäten"],
    bi("-tät → feminin, Plural -en. Kurz: die Uni.", "-tät → feminine, plural -en. Short: die Uni."), S.bildung),
  v("b1_v_hochschule", "noun", "Hochschule", "die", ["college", "university"], ["die Hochschulen", "Hochschulen"],
    bi("die Schule → die Schulen.", "die Schule → die Schulen."), S.bildung),
  v("b1_v_durchfallen", "verb", "durchfallen", "sein", ["to fail (an exam)", "fail"], ["durchgefallen"],
    bi("Trennbar, mit sein: Ich bin durchgefallen.", "Separable, with sein: Ich bin durchgefallen."), S.bildung),
  v("b1_v_sprachkurs", "noun", "Sprachkurs", "der", ["language course"], ["die Sprachkurse", "Sprachkurse"],
    bi("der Kurs → die Kurse.", "der Kurs → die Kurse."), S.bildung),
  v("b1_v_sprachniveau", "noun", "Sprachniveau", "das", ["language level"], ["die Sprachniveaus", "Sprachniveaus"],
    bi("Fremdwort, Plural -s.", "Loanword, plural -s."), S.bildung),
  v("b1_v_fortbildung", "noun", "Fortbildung", "die", ["in-service training", "professional development"], ["die Fortbildungen", "Fortbildungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.bildung),
  v("b1_v_konzentrieren", "verb", "sich konzentrieren", "haben", ["to concentrate", "concentrate"], ["konzentriert"],
    bi("Reflexiv + auf + Akkusativ. -ieren → kein ge-.", "Reflexive + auf + accusative. -ieren → no ge-."), S.bildung),

  /* s05 */
  v("b1_v_medien", "noun", "Medien", "die", ["media"], [NO_PLURAL],
    bi("Nur Plural (Singular: das Medium).", "Plural only (singular: das Medium)."), S.medien),
  v("b1_v_netzwerk", "noun", "Netzwerk", "das", ["network"], ["die Netzwerke", "Netzwerke"],
    bi("Neutrum, Plural -e. Soziale Netzwerke.", "Neuter, plural -e. Soziale Netzwerke."), S.medien),
  v("b1_v_meldung", "noun", "Meldung", "die", ["report", "news item", "notification"], ["die Meldungen", "Meldungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.medien),
  v("b1_v_falschmeldung", "noun", "Falschmeldung", "die", ["fake news", "false report"], ["die Falschmeldungen", "Falschmeldungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.medien),
  v("b1_v_datenschutz", "noun", "Datenschutz", "der", ["data protection"], [NO_PLURAL],
    bi("Maskulin, kein Plural.", "Masculine, no plural."), S.medien),
  v("b1_v_privatsphaere", "noun", "Privatsphäre", "die", ["privacy"], [NO_PLURAL],
    bi("Feminin, kein Plural.", "Feminine, no plural."), S.medien),
  v("b1_v_diskutieren", "verb", "diskutieren", "haben", ["to discuss", "discuss"], ["diskutiert"],
    bi("-ieren → kein ge-. diskutieren über + Akkusativ.", "-ieren → no ge-. diskutieren über + accusative."), S.medien),

  /* s06 */
  v("b1_v_mobilitaet", "noun", "Mobilität", "die", ["mobility"], [NO_PLURAL],
    bi("-tät → feminin, kein Plural.", "-tät → feminine, no plural."), S.reisen),
  v("b1_v_nahverkehr", "noun", "Nahverkehr", "der", ["local public transport"], [NO_PLURAL],
    bi("Maskulin, kein Plural. Der öffentliche Nahverkehr (ÖPNV).", "Masculine, no plural. Der öffentliche Nahverkehr (ÖPNV)."), S.reisen),
  v("b1_v_fundbuero", "noun", "Fundbüro", "das", ["lost-property office", "lost and found"], ["die Fundbüros", "Fundbüros"],
    bi("das Büro → die Büros.", "das Büro → die Büros."), S.reisen),
  v("b1_v_ferienwohnung", "noun", "Ferienwohnung", "die", ["holiday flat", "vacation rental"], ["die Ferienwohnungen", "Ferienwohnungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.reisen),
  v("b1_v_pauschalreise", "noun", "Pauschalreise", "die", ["package holiday"], ["die Pauschalreisen", "Pauschalreisen"],
    bi("die Reise → die Reisen.", "die Reise → die Reisen."), S.reisen),
  v("b1_v_reiseziel", "noun", "Reiseziel", "das", ["destination"], ["die Reiseziele", "Reiseziele"],
    bi("das Ziel → die Ziele.", "das Ziel → die Ziele."), S.reisen),
  v("b1_v_fahrgemeinschaft", "noun", "Fahrgemeinschaft", "die", ["car pool", "car-sharing group"], ["die Fahrgemeinschaften", "Fahrgemeinschaften"],
    bi("-schaft → feminin, Plural -en.", "-schaft → feminine, plural -en."), S.reisen),

  /* s07 */
  v("b1_v_klimawandel", "noun", "Klimawandel", "der", ["climate change"], [NO_PLURAL],
    bi("Maskulin, kein Plural.", "Masculine, no plural."), S.umwelt),
  v("b1_v_erderwaermung", "noun", "Erderwärmung", "die", ["global warming"], [NO_PLURAL],
    bi("-ung → feminin, kein Plural.", "-ung → feminine, no plural."), S.umwelt),
  v("b1_v_umweltverschmutzung", "noun", "Umweltverschmutzung", "die", ["environmental pollution"], [NO_PLURAL],
    bi("-ung → feminin, kein Plural.", "-ung → feminine, no plural."), S.umwelt),
  v("b1_v_energie", "noun", "Energie", "die", ["energy"], ["die Energien", "Energien"],
    bi("-ie → feminin, Plural -n. Erneuerbare Energien.", "-ie → feminine, plural -n. Erneuerbare Energien."), S.umwelt),
  v("b1_v_strom", "noun", "Strom", "der", ["electricity", "power"], [NO_PLURAL],
    bi("Maskulin; als Elektrizität kein Plural. Strom sparen.", "Masculine; as electricity no plural. Strom sparen."), S.umwelt),
  v("b1_v_verbrauch", "noun", "Verbrauch", "der", ["consumption"], [NO_PLURAL],
    bi("Maskulin, kein Plural.", "Masculine, no plural."), S.umwelt),
  v("b1_v_verbrauchen", "verb", "verbrauchen", "haben", ["to consume", "to use up", "consume"], ["verbraucht"],
    bi("ver- → kein ge-: verbraucht.", "ver- → no ge-: verbraucht."), S.umwelt),
  v("b1_v_tier", "noun", "Tier", "das", ["animal"], ["die Tiere", "Tiere"],
    bi("Neutrum, Plural -e.", "Neuter, plural -e."), S.umwelt),
  v("b1_v_pflanze", "noun", "Pflanze", "die", ["plant"], ["die Pflanzen", "Pflanzen"],
    bi("-e → feminin, Plural -n.", "-e → feminine, plural -n."), S.umwelt),
  v("b1_v_art", "noun", "Art", "die", ["species", "kind", "way"], ["die Arten", "Arten"],
    bi("Feminin, Plural -en. Die Artenvielfalt.", "Feminine, plural -en. Die Artenvielfalt."), S.umwelt),

  /* s08 */
  v("b1_v_migration", "noun", "Migration", "die", ["migration"], [NO_PLURAL],
    bi("-ion → feminin; kein Plural.", "-ion → feminine; no plural."), S.gesellschaft),
  v("b1_v_migrant", "noun", "Migrant", "der", ["migrant"], ["die Migranten", "Migranten"],
    bi("n-Deklination: den Migranten. Die Migrantin.", "n-declension: den Migranten. Die Migrantin."), S.gesellschaft),
  v("b1_v_staatsangehoerigkeit", "noun", "Staatsangehörigkeit", "die", ["nationality", "citizenship"], ["die Staatsangehörigkeiten", "Staatsangehörigkeiten"],
    bi("-keit → feminin, Plural -en.", "-keit → feminine, plural -en."), S.gesellschaft),
  v("b1_v_gleichberechtigung", "noun", "Gleichberechtigung", "die", ["equality", "equal rights"], [NO_PLURAL],
    bi("-ung → feminin, kein Plural.", "-ung → feminine, no plural."), S.gesellschaft),
  v("b1_v_toleranz", "noun", "Toleranz", "die", ["tolerance"], [NO_PLURAL],
    bi("Feminin, kein Plural. Adjektiv: tolerant.", "Feminine, no plural. Adjective: tolerant."), S.gesellschaft),
  v("b1_v_generation", "noun", "Generation", "die", ["generation"], ["die Generationen", "Generationen"],
    bi("-ion → feminin, Plural -en.", "-ion → feminine, plural -en."), S.gesellschaft),
  v("b1_v_zusammenhalt", "noun", "Zusammenhalt", "der", ["cohesion", "solidarity"], [NO_PLURAL],
    bi("Maskulin, kein Plural.", "Masculine, no plural."), S.gesellschaft),
  v("b1_v_stellungnahme", "noun", "Stellungnahme", "die", ["statement of opinion", "comment"], ["die Stellungnahmen", "Stellungnahmen"],
    bi("-e → feminin, Plural -n.", "-e → feminine, plural -n."), S.gesellschaft),

  /* s09 */
  v("b1_v_abschliessen", "verb", "abschließen", "haben", ["to take out (a contract)", "to conclude", "to lock", "conclude"], ["abgeschlossen"],
    bi("Trennbar: ab-ge-schlossen. Einen Vertrag abschließen.", "Separable: ab-ge-schlossen. Einen Vertrag abschließen."), S.konsum),
  v("b1_v_laufzeit", "noun", "Laufzeit", "die", ["contract term", "duration"], ["die Laufzeiten", "Laufzeiten"],
    bi("die Zeit → die Zeiten.", "die Zeit → die Zeiten."), S.konsum),
  v("b1_v_ueberweisung", "noun", "Überweisung", "die", ["bank transfer"], ["die Überweisungen", "Überweisungen"],
    bi("-ung → feminin, Plural -en.", "-ung → feminine, plural -en."), S.konsum),
  v("b1_v_lastschrift", "noun", "Lastschrift", "die", ["direct debit"], ["die Lastschriften", "Lastschriften"],
    bi("die Schrift → die Schriften.", "die Schrift → die Schriften."), S.konsum),
  v("b1_v_ausgabe", "noun", "Ausgabe", "die", ["expense", "spending", "edition"], ["die Ausgaben", "Ausgaben"],
    bi("-e → feminin. Ausgaben und Einnahmen.", "-e → feminine. Ausgaben und Einnahmen."), S.konsum),
  v("b1_v_einnahme", "noun", "Einnahme", "die", ["income", "takings"], ["die Einnahmen", "Einnahmen"],
    bi("-e → feminin, meist Plural: die Einnahmen.", "-e → feminine, mostly plural: die Einnahmen."), S.konsum),
  v("b1_v_kredit", "noun", "Kredit", "der", ["loan", "credit"], ["die Kredite", "Kredite"],
    bi("Maskulin, Plural -e. Einen Kredit aufnehmen.", "Masculine, plural -e. Einen Kredit aufnehmen."), S.konsum),
  v("b1_v_schulden", "noun", "Schulden", "die", ["debts"], [NO_PLURAL],
    bi("Nur Plural. Schulden haben / machen.", "Plural only. Schulden haben / machen."), S.konsum),
  v("b1_v_kundenservice", "noun", "Kundenservice", "der", ["customer service"], [NO_PLURAL],
    bi("Maskulin, kein Plural.", "Masculine, no plural."), S.konsum),
  v("b1_v_rabatt", "noun", "Rabatt", "der", ["discount"], ["die Rabatte", "Rabatte"],
    bi("Maskulin, Plural -e.", "Masculine, plural -e."), S.konsum),

  /* s10 */
  v("b1_v_karneval", "noun", "Karneval", "der", ["carnival"], ["die Karnevale", "Karnevale", "die Karnevals", "Karnevals"],
    bi("Im Süden: der Fasching. Plural selten.", "In the south: der Fasching. Plural rare."), S.feste),
  v("b1_v_fasching", "noun", "Fasching", "der", ["carnival (southern Germany, Austria)"], ["die Faschinge", "Faschinge", "die Faschings", "Faschings"],
    bi("Maskulin; Plural selten.", "Masculine; plural rare."), S.feste),
  v("b1_v_adventskalender", "noun", "Adventskalender", "der", ["advent calendar"], ["die Adventskalender", "Adventskalender"],
    bi("der Kalender → die Kalender.", "der Kalender → die Kalender."), S.feste),
  v("b1_v_oktoberfest", "noun", "Oktoberfest", "das", ["Oktoberfest"], ["die Oktoberfeste", "Oktoberfeste"],
    bi("das Fest → die Feste.", "das Fest → die Feste."), S.feste),
  v("b1_v_kultur", "noun", "Kultur", "die", ["culture"], ["die Kulturen", "Kulturen"],
    bi("Feminin, Plural -en.", "Feminine, plural -en."), S.feste),
  v("b1_v_zukunft", "noun", "Zukunft", "die", ["future"], [NO_PLURAL],
    bi("Feminin, kein Plural. In Zukunft.", "Feminine, no plural. In Zukunft."), S.feste),

  /* s11 */
  v("b1_v_eifersucht", "noun", "Eifersucht", "die", ["jealousy"], [NO_PLURAL],
    bi("Feminin, kein Plural. Adjektiv: eifersüchtig.", "Feminine, no plural. Adjective: eifersüchtig."), S.gefuehle),
  v("b1_v_freude", "noun", "Freude", "die", ["joy", "pleasure"], ["die Freuden", "Freuden"],
    bi("-e → feminin, Plural -n.", "-e → feminine, plural -n."), S.gefuehle),
  v("b1_v_erziehung", "noun", "Erziehung", "die", ["upbringing", "education"], [NO_PLURAL],
    bi("-ung → feminin, kein Plural.", "-ung → feminine, no plural."), S.gefuehle),
  v("b1_v_erziehen", "verb", "erziehen", "haben", ["to bring up", "to raise (a child)", "bring up"], ["erzogen"],
    bi("ie → o: erzogen. er- → kein ge-.", "ie → o: erzogen. er- → no ge-."), S.gefuehle),

  /* s12 */
  v("b1_v_heimatland", "noun", "Heimatland", "das", ["home country"], ["die Heimatländer", "Heimatländer"],
    bi("das Land → die Länder.", "das Land → die Länder."), S.pruefung),
  v("b1_v_aufmerksamkeit", "noun", "Aufmerksamkeit", "die", ["attention"], [NO_PLURAL],
    bi("-keit → feminin. Vielen Dank für Ihre Aufmerksamkeit.", "-keit → feminine. Vielen Dank für Ihre Aufmerksamkeit."), S.pruefung)
];
